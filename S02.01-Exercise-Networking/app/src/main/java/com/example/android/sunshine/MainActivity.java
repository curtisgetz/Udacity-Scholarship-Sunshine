...
public class MainActivity extends AppCompatActivity {
    ...
    */
    ...
    //   (8) Create a method that will get the user's preferred location and
    // execute your new AsyncTask and call it loadWeatherData
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]>{
        ...
        protected String[] doInBackground(String... params) {
           if(params.length < 1 || params == null){
            ...
            URL weatherRequestURL = NetworkUtils.buildUrl(searchUrl);
            try{
