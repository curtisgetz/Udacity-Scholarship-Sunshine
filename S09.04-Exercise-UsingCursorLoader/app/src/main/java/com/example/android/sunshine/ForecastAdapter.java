...
//       (8) Display the summary that you created above
        ...
        String summary;
        long dateInMillis = mCursor.getLong(MainActivity.DATE_INDEX);
        String dateString = SunshineDateUtils.getFriendlyDateString(mContext, dateInMillis, false);

        String description = SunshineWeatherUtils.getStringForWeatherCondition(mContext,
                mCursor.getInt(MainActivity.WEATHER_ID_INDEX));


        double high = mCursor.getDouble(MainActivity.MAX_TEMP_INDEX);
        double low = mCursor.getDouble(MainActivity.MIN_TEMP_INDEX);

        String highLowString = SunshineWeatherUtils.formatHighLows(mContext, high, low);
        summary = dateString + " - " + description + " - " + highLowString;
