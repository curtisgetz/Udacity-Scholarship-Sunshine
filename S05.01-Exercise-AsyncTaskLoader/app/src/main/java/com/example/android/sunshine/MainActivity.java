...
public class MainActivity extends AppCompatActivity implements
        ...
        LoaderManager.LoaderCallbacks<String[]> {//implements ForecastAdapterOnClickHandler {

    private static final String TAG = MainActivity.class.getSimpleName();

    private static final String WEATHER_EXTRA = "weather";
    private static final int LOADER_KEY = 10;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportLoaderManager().initLoader(LOADER_KEY, bundleForLoader, callBack);
    }
    ...
    public void invalidateData(){ mForecastAdapter.setWeatherData(null);}
    /**
